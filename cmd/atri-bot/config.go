...
func getConfig() (*Config, error) {
	...
	v.SetDefault("default.image_max_edge", configmanager.DefaultImageMaxEdge)
	...
	v.SetDefault("files.max_storage_mb", 1024)
	v.SetDefault("files.cleanup_after", "7d")
...
func (c *Config) validate() error {
	...
	if c.Default.ImageMaxEdge <= 0 || c.Default.ImageMaxEdge > configmanager.MaxImageMaxEdge {
		return fmt.Errorf("configuration default.image_max_edge must be between 1 and %d", configmanager.MaxImageMaxEdge)
	}
